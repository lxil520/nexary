...
| --- | --- | --- | --- |
| Spring Boot 2.7 | Java 8+ | Disruptor / Kafka / RocketMQ | 未验证，不要按已支持能力接入 |
...
Boot2 / Java8+ 的 Messaging 已验证范围只包括 Redis-only。不要把 Disruptor、Kafka、RocketMQ 的 Boot2/JDK8 支持写成已支持；这些 provider 需要各自独立兼容 gate。
