...
public class RedisBoot4CacheCounterClient implements CacheCounterClient {
    ...
    public RedisBoot4CacheCounterClient(StringRedisTemplate stringRedisTemplate) {
        this(stringRedisTemplate, NexaryObservationPublisher.noop());
    }

    public RedisBoot4CacheCounterClient(
    ...
    public CacheCounterMutation increment(CacheCounterKey key, long delta, Duration ttlOnCreate) {
        ...
        try {
            ...
            RedisBoot4CacheObservation.publish(observationPublisher, operation, "none", "success", startedAt);
            return mutation;
    ...
    public OptionalLong current(CacheCounterKey key) {
        ...
        try {
            ...
            if (value == null) {
                RedisBoot4CacheObservation.publish(observationPublisher, "cache.counter_current", "none", "miss", startedAt);
                return OptionalLong.empty();
            }
            RedisBoot4CacheObservation.publish(observationPublisher, "cache.counter_current", "none", "hit", startedAt);
