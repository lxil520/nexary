...
public class RedisBoot4CacheInvalidationSubscriber implements MessageListener, SmartLifecycle {
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        try {
            ...
            CacheInvalidationEvent event = RedisBoot4CacheInvalidationCodec.decode(payload);
