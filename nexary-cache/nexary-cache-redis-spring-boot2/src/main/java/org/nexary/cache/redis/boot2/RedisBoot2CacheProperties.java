...
/** Redis cache adapter settings for the Boot2 compatibility line. */
@ConfigurationProperties(prefix = "nexary.cache.redis")
public class RedisBoot2CacheProperties {
    ...
    public void setProviderName(String providerName) {
        this.providerName = RedisBoot2ProtocolCacheProviderCondition.normalize(providerName);
    }
}
