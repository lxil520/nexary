...
| Spring Boot 2.7 | Java 8+ | `0.2.x` 目标，优先兼容审计和适配 | 独立 Boot2 starter / BOM，未发布 |
| Spring Boot 4.x | Java 21+ 主验证目标 | `0.2.x` 目标，Boot2 gate 通过后推进 | 独立 Boot4 starter / BOM 候选；官方最低 JDK 仍以 Spring 文档为准 |
