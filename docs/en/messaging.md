...
Choose the entry point from your Spring Boot and JDK line first. Examples use the current development version `0.12.0`; after Maven Central publication, replace it with the latest release.
