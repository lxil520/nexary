...
Processor-style integration exposes only Nexary's own job API. Handler types, parameter types, and naming from historical projects do not enter the Nexary public API.
