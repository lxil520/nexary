...
Current development version: `0.4.0`. After publication, replace `${nexary.version}` with the latest release / tag version.
...
```groovy
dependencies {
    implementation "com.aweimao:nexary-cache-api:0.4.0"
    runtimeOnly "com.aweimao:nexary-cache-redis-spring-boot2:0.4.0"
}
```
...
dependencies {
    implementation "com.aweimao:nexary-cache-api:0.4.0"
    runtimeOnly "com.aweimao:nexary-cache-redis-spring-boot4:0.4.0"
}
```
