...
This document is the engineering standards guide for Nexary maintainers and contributors. It keeps public APIs, samples, documentation, and tests consistent over time.
...
- validation records should state commands, environment, results, and known limitations
