...
class JobLoadBalancersTest {
    private final List<JobWorker> workers = Arrays.asList(JobWorker.of("node-a"), JobWorker.of("node-b"), JobWorker.of("node-c"));
    ...
    void leastActivePrefersLowestActiveWorker() {
        ...
        List<JobWorker> candidates = Arrays.asList(new JobWorker("node-a", 3, 1), new JobWorker("node-b", 1, 1));
