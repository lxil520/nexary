...
| 2.7.x | Java 8+ | 目标 / 待验证 / 未发布 | 拟定 `nexary-job-spring-boot2-starter` |
| 4.x | Java 21+ 主验证目标 | 目标 / 待验证 / 未发布 | 拟定 `nexary-job-spring-boot4-starter` |

Boot2 / Boot4 artifact 在独立验证前不要作为可用依赖复制到业务项目。
