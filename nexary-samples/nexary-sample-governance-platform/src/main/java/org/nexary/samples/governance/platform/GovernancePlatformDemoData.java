...
public final class GovernancePlatformDemoData implements ApplicationRunner {
    ...
    private List<GovernanceAsset> assets() {
        return List.of(
                ...
                service("repair-job-worker", "Repair Job Worker", "repair-job-cluster", "cn-east", "18", "0.002", "180", "360", "4", "32", "41", "39", "CLOSED", "HEALTHY", "2.1", "0.1", "0.002"),
                ...
                instance("repair-job-worker-01", "repair-job-worker", "repair-job-cluster", "cn-east", "HEALTHY", "32", "41", "2", "18", "2.1", "0.1", "460", "82", "16", "NONE"),
    ...
    private List<GovernanceDependency> dependencies() {
        return List.of(
                ...
                dependency("repair-job-worker", "room-resource", GovernanceDependencyKind.JOB, "job:repair-job-worker:repair-room"),
