...
当前开发版本使用 `0.3.1`。发布到 Maven Central 后，把版本替换为最新 release / tag。这里的 Boot4/JDK21 表述只代表 Nexary Cache 的主验证运行时，不是 Spring 官方 JDK 基线说明，也不代表 messaging、job 或整个仓库已经完成 Boot4 支持。
