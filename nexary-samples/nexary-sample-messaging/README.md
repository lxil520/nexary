...
样例业务代码只使用 Nexary messaging API，因此 Boot3、Boot2 Redis-only、Boot4 provider-by-provider 的差异只在依赖和配置入口。当前开发版本示例统一使用 `0.3.1`；发布到 Maven Central 后，把示例中的版本替换成最新 release。
